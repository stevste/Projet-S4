...
class Aetoile:
   def __init__(self):
        ...
        for i in range(len(self.config_actuelle)):
            if self.config_actuelle[i].position==(0,0):
                self.listePiece[0][0]=self.config_actuelle[i].couleur
            if self.config_actuelle[i].position==(1,1):
                self.listePiece[1][1]=self.config_actuelle[i].couleur
            if self.config_actuelle[i].position==(2,2):
                self.listePiece[2][2]=self.config_actuelle[i].couleur            
            if self.config_actuelle[i].position==(1,0):
                self.listePiece[0][1]=self.config_actuelle[i].couleur
            if self.config_actuelle[i].position==(2,0):
                self.listePiece[0][2]=self.config_actuelle[i].couleur
            if self.config_actuelle[i].position==(0,1):
                self.listePiece[1][0]=self.config_actuelle[i].couleur
            if self.config_actuelle[i].position==(0,2):
                self.listePiece[2][0]=self.config_actuelle[i].couleur
            if self.config_actuelle[i].position==(1,2):
                self.listePiece[2][1]=self.config_actuelle[i].couleur
            if self.config_actuelle[i].position==(2,1):
                self.listePiece[1][2]=self.config_actuelle[i].couleur
   ...
   def verif_close(self, config:list, close:list)-> bool:  
   ...
   def mouvement(self)-> list:
       ...
       while self.open != []:
           ...
           #ligne 1 a droite
           config=[[self.enCours[0][0][2],self.enCours[0][0][0],self.enCours[0][0][1]],self.enCours[0][1],self.enCours[0][2]]
           
           verifBut=self.but(config)
           if verifBut==True:
               return self.chemin(config, self.parent)
           verifClose=self.verif_close(config, self.close)
           if verifClose==False:
               self.newPosition=[config,self.parent,self.g,0,self.f]
               self.open.append(self.newPosition)
               
           #ligne 2 a droite
           config=[self.enCours[0][0],[self.enCours[0][1][2],self.enCours[0][1][0],self.enCours[0][1][1]],self.enCours[0][2]]
           ...
           #ligne 3 a droite
           config=[self.enCours[0][0],self.enCours[0][1],[self.enCours[0][2][2],self.enCours[0][2][0],self.enCours[0][2][1]]]
           ...
           # colone 1 en bas
           config=[[self.enCours[0][2][0],self.enCours[0][0][1],self.enCours[0][0][2]],
                   [self.enCours[0][0][0],self.enCours[0][1][1],self.enCours[0][1][2]],
                   [self.enCours[0][1][0],self.enCours[0][2][1],self.enCours[0][2][2]]]
           ...
           # colone 2 en bas
           config=[[self.enCours[0][0][0],self.enCours[0][2][1],self.enCours[0][0][2]],
                   [self.enCours[0][1][0],self.enCours[0][0][1],self.enCours[0][1][2]],
                   [self.enCours[0][2][0],self.enCours[0][1][1],self.enCours[0][2][2]]]
           ...
           # colone 3 en bas
           config=[[self.enCours[0][0][0],self.enCours[0][0][1],self.enCours[0][2][2]],
                   [self.enCours[0][1][0],self.enCours[0][1][1],self.enCours[0][0][2]],
                   [self.enCours[0][2][0],self.enCours[0][2][1],self.enCours[0][1][2]]]
